...
const BreadSection = () => {
  return (
    <section id="block4" className="relative bg-cover bg-center bg-gray-900 bg-opacity-60" style={{ backgroundImage: "url('/tt-min.jpg')" }}>
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 text-white">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {/* Glassic Baguette */}
          <div className="bg-black bg-opacity-60 p-6 rounded-2xl text-center">
            <h5 className="text-xl font-semibold mb-4">Glassic Baguette</h5>
            <p>Unbleached organic wheat flour, whole rye flour, water, sea salt, yeast</p>
          </div>
          {/* Baguette */}
          <div className="bg-black bg-opacity-60 p-6 rounded-2xl text-center">
            <h5 className="text-xl font-semibold mb-4">Baguette</h5>
          ...
          {/* Pekan Raisin */}
          <div className="bg-black bg-opacity-60 p-6 rounded-2xl text-center">
            <h5 className="text-xl font-semibold mb-4">Pekan Raisin</h5>
          ...
          {/* Everyday French */}
          <div className="bg-black bg-opacity-60 p-6 rounded-2xl text-center">
            <h5 className="text-xl font-semibold mb-4">Everyday French</h5>
            <p>Everyday table loaf made using the Classic Baguette dough</p>
          </div>
          {/* Multigrain */}
          <div className="bg-black bg-opacity-60 p-6 rounded-2xl text-center">
            <h5 className="text-xl font-semibold mb-4">Multigrain</h5>
          ...
          {/* Danish Rye */}
          <div className="bg-black bg-opacity-60 p-6 rounded-2xl text-center">
            <h5 className="text-xl font-semibold mb-4">Danish Rye</h5>
